...
@Component({
  selector: 'app-inscription-collaborator-type-create-collaborator',
  templateUrl: './inscription-collaborator-type-create-collaborator.component.html'
})
export class InscriptionCollaboratorTypeCreateCollaboratorComponent  implements OnInit {
   ...
   private _validInscriptionCollaboratorTypeName = true;
    ...
    public  setValidation(value: boolean){
        this.validInscriptionCollaboratorTypeCode = value;
        this.validInscriptionCollaboratorTypeName = value;
    }
    ...
    public  validateForm(): void{
        ...
        this.validateInscriptionCollaboratorTypeCode();
        this.validateInscriptionCollaboratorTypeName();
    }

    public validateInscriptionCollaboratorTypeCode(){
        if (this.stringUtilService.isEmpty(this.item.code)) {
        this.errorMessages.push('Code non valide');
        this.validInscriptionCollaboratorTypeCode = false;
        } else {
            this.validInscriptionCollaboratorTypeCode = true;
        }
    }
    public validateInscriptionCollaboratorTypeName(){
        if (this.stringUtilService.isEmpty(this.item.name)) {
        this.errorMessages.push('Name non valide');
        this.validInscriptionCollaboratorTypeName = false;
        } else {
            this.validInscriptionCollaboratorTypeName = true;
        }
    }
