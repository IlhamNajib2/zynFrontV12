...
@Component({
  selector: 'app-inscription-collaborator-type-view-collaborator',
  templateUrl: './inscription-collaborator-type-view-collaborator.component.html'
})
export class InscriptionCollaboratorTypeViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: InscriptionCollaboratorTypeCollaboratorService){
