...
@Component({
  selector: 'app-inscription-collaborator-type-edit-collaborator',
  templateUrl: './inscription-collaborator-type-edit-collaborator.component.html'
})
export class InscriptionCollaboratorTypeEditCollaboratorComponent implements OnInit {
