...
@Component({
  selector: 'app-inscription-membre-state-create-collaborator',
  templateUrl: './inscription-membre-state-create-collaborator.component.html'
})
export class InscriptionMembreStateCreateCollaboratorComponent  implements OnInit {
