...
@Component({
  selector: 'app-inscription-membre-state-view-collaborator',
  templateUrl: './inscription-membre-state-view-collaborator.component.html'
})
export class InscriptionMembreStateViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: InscriptionMembreStateCollaboratorService){
