...
@Component({
  selector: 'app-inscription-membre-state-list-collaborator',
  templateUrl: './inscription-membre-state-list-collaborator.component.html'
})
export class InscriptionMembreStateListCollaboratorComponent implements OnInit {
