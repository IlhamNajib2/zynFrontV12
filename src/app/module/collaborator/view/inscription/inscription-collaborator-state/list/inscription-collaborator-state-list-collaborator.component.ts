...
@Component({
  selector: 'app-inscription-collaborator-state-list-collaborator',
  templateUrl: './inscription-collaborator-state-list-collaborator.component.html'
})
export class InscriptionCollaboratorStateListCollaboratorComponent implements OnInit {
