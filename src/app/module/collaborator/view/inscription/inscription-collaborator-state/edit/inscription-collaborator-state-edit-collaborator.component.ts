...
@Component({
  selector: 'app-inscription-collaborator-state-edit-collaborator',
  templateUrl: './inscription-collaborator-state-edit-collaborator.component.html'
})
export class InscriptionCollaboratorStateEditCollaboratorComponent implements OnInit {
