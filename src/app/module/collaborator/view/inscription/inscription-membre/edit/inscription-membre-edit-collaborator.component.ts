...
@Component({
  selector: 'app-inscription-membre-edit-collaborator',
  templateUrl: './inscription-membre-edit-collaborator.component.html'
})
export class InscriptionMembreEditCollaboratorComponent implements OnInit {
