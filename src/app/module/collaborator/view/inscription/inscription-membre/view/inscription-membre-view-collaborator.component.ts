...
@Component({
  selector: 'app-inscription-membre-view-collaborator',
  templateUrl: './inscription-membre-view-collaborator.component.html'
})
export class InscriptionMembreViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: InscriptionMembreCollaboratorService, private inscriptionMembreStateService: InscriptionMembreStateCollaboratorService, private inscriptionCollaboratorService: InscriptionCollaboratorCollaboratorService, private memberService: MemberCollaboratorService){
