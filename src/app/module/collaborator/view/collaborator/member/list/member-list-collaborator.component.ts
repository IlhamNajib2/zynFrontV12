...
@Component({
  selector: 'app-member-list-collaborator',
  templateUrl: './member-list-collaborator.component.html'
})
export class MemberListCollaboratorComponent implements OnInit {

    protected fileName = 'Member';
    ...
    constructor( private service: MemberCollaboratorService  , private collaboratorService: CollaboratorCollaboratorService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<MemberDto>();
    ...
    public async edit(dto: MemberDto) {
    ...
    public async view(dto: MemberDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: MemberDto) {
    ...
    public async duplicate(dto: MemberDto) {
    ...
    public exportPdf(dto: MemberDto): void {
...
// add
	...
	public initDuplicate(res: MemberDto) {
	}
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<MemberDto> {
        return this.service.selections;
    }

    set selections(value: Array<MemberDto>) {
