...
@Component({
  selector: 'app-member-view-collaborator',
  templateUrl: './member-view-collaborator.component.html'
})
export class MemberViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: MemberCollaboratorService, private collaboratorService: CollaboratorCollaboratorService){
