...
@Component({
  selector: 'app-collaborator-view-collaborator',
  templateUrl: './collaborator-view-collaborator.component.html'
})
export class CollaboratorViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: CollaboratorCollaboratorService){
