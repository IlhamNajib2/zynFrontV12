...
@Component({
  selector: 'app-collaborator-list-collaborator',
  templateUrl: './collaborator-list-collaborator.component.html'
})
export class CollaboratorListCollaboratorComponent implements OnInit {

    protected fileName = 'Collaborator';
    ...
    constructor( private service: CollaboratorCollaboratorService  , @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<CollaboratorDto>();
    ...
    public async edit(dto: CollaboratorDto) {
    ...
    public async view(dto: CollaboratorDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: CollaboratorDto) {
    ...
    public async duplicate(dto: CollaboratorDto) {
    ...
    public exportPdf(dto: CollaboratorDto): void {
...
// add
	...
	public initDuplicate(res: CollaboratorDto) {
	}
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<CollaboratorDto> {
        return this.service.selections;
    }

    set selections(value: Array<CollaboratorDto>) {
