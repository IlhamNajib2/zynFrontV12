...
import {PaimentInfluencerCollaboratorService} from 'src/app/shared/service/collaborator/paiment/PaimentInfluencerCollaborator.service';
...
@Component({
  selector: 'app-paiment-influencer-create-collaborator',
  templateUrl: './paiment-influencer-create-collaborator.component.html'
})
export class PaimentInfluencerCreateCollaboratorComponent  implements OnInit {
   ...
   private _validPaimentInfluencerCode = true;
	...
	constructor(private service: PaimentInfluencerCollaboratorService , private couponService: CouponCollaboratorService, private influencerService: InfluencerCollaboratorService, private paimentInfluencerStateService: PaimentInfluencerStateCollaboratorService, @Inject(PLATFORM_ID) private platformId? ) {
