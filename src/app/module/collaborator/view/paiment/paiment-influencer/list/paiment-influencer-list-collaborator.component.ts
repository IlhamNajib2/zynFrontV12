...
@Component({
  selector: 'app-paiment-influencer-list-collaborator',
  templateUrl: './paiment-influencer-list-collaborator.component.html'
})
export class PaimentInfluencerListCollaboratorComponent implements OnInit {
