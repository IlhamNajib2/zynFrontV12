...
@Component({
  selector: 'app-paiment-influencer-view-collaborator',
  templateUrl: './paiment-influencer-view-collaborator.component.html'
})
export class PaimentInfluencerViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: PaimentInfluencerCollaboratorService, private couponService: CouponCollaboratorService, private influencerService: InfluencerCollaboratorService, private paimentInfluencerStateService: PaimentInfluencerStateCollaboratorService){
