...
@Component({
  selector: 'app-paiment-influencer-edit-collaborator',
  templateUrl: './paiment-influencer-edit-collaborator.component.html'
})
export class PaimentInfluencerEditCollaboratorComponent implements OnInit {
