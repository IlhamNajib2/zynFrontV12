...
@Component({
  selector: 'app-category-template-edit-collaborator',
  templateUrl: './category-template-edit-collaborator.component.html'
})
export class CategoryTemplateEditCollaboratorComponent implements OnInit {
