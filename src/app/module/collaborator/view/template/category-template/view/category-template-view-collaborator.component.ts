...
@Component({
  selector: 'app-category-template-view-collaborator',
  templateUrl: './category-template-view-collaborator.component.html'
})
export class CategoryTemplateViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: CategoryTemplateCollaboratorService){
