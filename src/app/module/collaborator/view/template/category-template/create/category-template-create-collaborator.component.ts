...
@Component({
  selector: 'app-category-template-create-collaborator',
  templateUrl: './category-template-create-collaborator.component.html'
})
export class CategoryTemplateCreateCollaboratorComponent  implements OnInit {
