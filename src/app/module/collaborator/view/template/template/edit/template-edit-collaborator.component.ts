...
@Component({
  selector: 'app-template-edit-collaborator',
  templateUrl: './template-edit-collaborator.component.html'
})
export class TemplateEditCollaboratorComponent implements OnInit {
