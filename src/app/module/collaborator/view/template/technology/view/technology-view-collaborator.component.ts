...
@Component({
  selector: 'app-technology-view-collaborator',
  templateUrl: './technology-view-collaborator.component.html'
})
export class TechnologyViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: TechnologyCollaboratorService, private typeTemplateService: TypeTemplateCollaboratorService){
