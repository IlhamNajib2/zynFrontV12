...
@Component({
  selector: 'app-technology-create-collaborator',
  templateUrl: './technology-create-collaborator.component.html'
})
export class TechnologyCreateCollaboratorComponent  implements OnInit {
