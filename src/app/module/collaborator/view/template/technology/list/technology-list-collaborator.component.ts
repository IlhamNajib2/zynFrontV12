...
@Component({
  selector: 'app-technology-list-collaborator',
  templateUrl: './technology-list-collaborator.component.html'
})
export class TechnologyListCollaboratorComponent implements OnInit {
