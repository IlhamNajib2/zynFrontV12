...
@Component({
  selector: 'app-level-template-edit-collaborator',
  templateUrl: './level-template-edit-collaborator.component.html'
})
export class LevelTemplateEditCollaboratorComponent implements OnInit {
