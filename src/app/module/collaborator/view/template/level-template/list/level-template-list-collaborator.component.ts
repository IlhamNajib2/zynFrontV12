...
@Component({
  selector: 'app-level-template-list-collaborator',
  templateUrl: './level-template-list-collaborator.component.html'
})
export class LevelTemplateListCollaboratorComponent implements OnInit {
