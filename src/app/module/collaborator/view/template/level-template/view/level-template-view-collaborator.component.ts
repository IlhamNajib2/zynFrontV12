...
@Component({
  selector: 'app-level-template-view-collaborator',
  templateUrl: './level-template-view-collaborator.component.html'
})
export class LevelTemplateViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: LevelTemplateCollaboratorService){
