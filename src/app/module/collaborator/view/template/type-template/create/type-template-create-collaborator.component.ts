...
@Component({
  selector: 'app-type-template-create-collaborator',
  templateUrl: './type-template-create-collaborator.component.html'
})
export class TypeTemplateCreateCollaboratorComponent  implements OnInit {
