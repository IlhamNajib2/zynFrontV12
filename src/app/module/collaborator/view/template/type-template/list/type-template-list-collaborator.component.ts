...
@Component({
  selector: 'app-type-template-list-collaborator',
  templateUrl: './type-template-list-collaborator.component.html'
})
export class TypeTemplateListCollaboratorComponent implements OnInit {
