...
@Component({
  selector: 'app-type-template-view-collaborator',
  templateUrl: './type-template-view-collaborator.component.html'
})
export class TypeTemplateViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: TypeTemplateCollaboratorService){
