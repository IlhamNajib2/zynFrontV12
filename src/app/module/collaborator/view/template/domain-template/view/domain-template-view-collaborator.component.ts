...
@Component({
  selector: 'app-domain-template-view-collaborator',
  templateUrl: './domain-template-view-collaborator.component.html'
})
export class DomainTemplateViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: DomainTemplateCollaboratorService){
