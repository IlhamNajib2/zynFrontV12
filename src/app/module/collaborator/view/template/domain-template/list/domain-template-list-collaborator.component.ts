...
@Component({
  selector: 'app-domain-template-list-collaborator',
  templateUrl: './domain-template-list-collaborator.component.html'
})
export class DomainTemplateListCollaboratorComponent implements OnInit {
