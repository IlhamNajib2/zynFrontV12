...
@Component({
  selector: 'app-domain-template-create-collaborator',
  templateUrl: './domain-template-create-collaborator.component.html'
})
export class DomainTemplateCreateCollaboratorComponent  implements OnInit {
