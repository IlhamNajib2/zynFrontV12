...
@Component({
  selector: 'app-influencer-list-collaborator',
  templateUrl: './influencer-list-collaborator.component.html'
})
export class InfluencerListCollaboratorComponent implements OnInit {

    protected fileName = 'Influencer';
    ...
    constructor( private service: InfluencerCollaboratorService  , @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<InfluencerDto>();
    ...
    public async edit(dto: InfluencerDto) {
    ...
    public async view(dto: InfluencerDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: InfluencerDto) {
    ...
    public async duplicate(dto: InfluencerDto) {
    ...
    public exportPdf(dto: InfluencerDto): void {
...
// add
	...
	public initDuplicate(res: InfluencerDto) {
	}
   ...
   public prepareColumnExport(): void {
    ...
    get items(): Array<InfluencerDto> {
        return this.service.items;
    }

    set items(value: Array<InfluencerDto>) {
        this.service.items = value;
    }

    get selections(): Array<InfluencerDto> {
        return this.service.selections;
    }

    set selections(value: Array<InfluencerDto>) {
        this.service.selections = value;
    }

    get item(): InfluencerDto {
        return this.service.item;
    }

    set item(value: InfluencerDto) {
    ...
    get criteria(): InfluencerCriteria {
        return this.service.criteria;
    }

    set criteria(value: InfluencerCriteria) {
