...
@Component({
  selector: 'app-coupon-detail-edit-collaborator',
  templateUrl: './coupon-detail-edit-collaborator.component.html'
})
export class CouponDetailEditCollaboratorComponent implements OnInit {
