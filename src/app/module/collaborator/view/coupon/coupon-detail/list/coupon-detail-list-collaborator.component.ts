...
@Component({
  selector: 'app-coupon-detail-list-collaborator',
  templateUrl: './coupon-detail-list-collaborator.component.html'
})
export class CouponDetailListCollaboratorComponent implements OnInit {

    protected fileName = 'CouponDetail';
    ...
    constructor( private service: CouponDetailCollaboratorService  , private couponService: CouponCollaboratorService, private packagingService: PackagingCollaboratorService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<CouponDetailDto>();
    ...
    public async edit(dto: CouponDetailDto) {
    ...
    public async view(dto: CouponDetailDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: CouponDetailDto) {
    ...
    public async duplicate(dto: CouponDetailDto) {
    ...
    public exportPdf(dto: CouponDetailDto): void {
...
// add
    ...
    public initCol() {
        this.cols = [
            ...
            {field: 'amountGivenInfluencer', header: 'Amount given influencer'},
            {field: 'usingNumber', header: 'Using number'},
            {field: 'maxUsingNumber', header: 'Max using number'},
	...
	public initDuplicate(res: CouponDetailDto) {
	}
   ...
   public prepareColumnExport(): void {
        this.exportData = this.items.map(e => {
            return {
                'Packaging': e.packaging?.id ,
                 'Discount': e.discount ,
                 'Amount given influencer': e.amountGivenInfluencer ,
                 'Using number': e.usingNumber ,
                 'Max using number': e.maxUsingNumber ,
        ...
        //'Packaging': this.criteria.packaging?.id ? this.criteria.packaging?.id : environment.emptyForExport ,
            ...
            'Amount given influencer Min': this.criteria.amountGivenInfluencerMin ? this.criteria.amountGivenInfluencerMin : environment.emptyForExport ,
            'Amount given influencer Max': this.criteria.amountGivenInfluencerMax ? this.criteria.amountGivenInfluencerMax : environment.emptyForExport ,
            ...
            'Max using number Min': this.criteria.maxUsingNumberMin ? this.criteria.maxUsingNumberMin : environment.emptyForExport ,
            'Max using number Max': this.criteria.maxUsingNumberMax ? this.criteria.maxUsingNumberMax : environment.emptyForExport ,
    ...
    get selections(): Array<CouponDetailDto> {
        return this.service.selections;
    }

    set selections(value: Array<CouponDetailDto>) {
