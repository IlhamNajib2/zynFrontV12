...
@Component({
  selector: 'app-coupon-detail-create-collaborator',
  templateUrl: './coupon-detail-create-collaborator.component.html'
})
export class CouponDetailCreateCollaboratorComponent  implements OnInit {
