...
@Component({
  selector: 'app-coupon-list-collaborator',
  templateUrl: './coupon-list-collaborator.component.html'
})
export class CouponListCollaboratorComponent implements OnInit {
