...
@Component({
  selector: 'app-coupon-create-collaborator',
  templateUrl: './coupon-create-collaborator.component.html'
})
export class CouponCreateCollaboratorComponent  implements OnInit {
