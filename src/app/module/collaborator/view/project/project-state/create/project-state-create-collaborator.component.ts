...
@Component({
  selector: 'app-project-state-create-collaborator',
  templateUrl: './project-state-create-collaborator.component.html'
})
export class ProjectStateCreateCollaboratorComponent  implements OnInit {
