...
@Component({
  selector: 'app-project-state-edit-collaborator',
  templateUrl: './project-state-edit-collaborator.component.html'
})
export class ProjectStateEditCollaboratorComponent implements OnInit {
