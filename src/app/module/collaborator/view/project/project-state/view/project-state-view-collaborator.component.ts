...
@Component({
  selector: 'app-project-state-view-collaborator',
  templateUrl: './project-state-view-collaborator.component.html'
})
export class ProjectStateViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: ProjectStateCollaboratorService){
