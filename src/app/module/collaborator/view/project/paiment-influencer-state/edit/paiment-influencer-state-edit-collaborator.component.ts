...
@Component({
  selector: 'app-paiment-influencer-state-edit-collaborator',
  templateUrl: './paiment-influencer-state-edit-collaborator.component.html'
})
export class PaimentInfluencerStateEditCollaboratorComponent implements OnInit {
