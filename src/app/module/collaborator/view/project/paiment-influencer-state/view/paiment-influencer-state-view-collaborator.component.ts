...
@Component({
  selector: 'app-paiment-influencer-state-view-collaborator',
  templateUrl: './paiment-influencer-state-view-collaborator.component.html'
})
export class PaimentInfluencerStateViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: PaimentInfluencerStateCollaboratorService){
