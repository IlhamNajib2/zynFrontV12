...
@Component({
  selector: 'app-paiment-influencer-state-create-collaborator',
  templateUrl: './paiment-influencer-state-create-collaborator.component.html'
})
export class PaimentInfluencerStateCreateCollaboratorComponent  implements OnInit {
