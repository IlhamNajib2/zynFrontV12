...
@Component({
  selector: 'app-category-packaging-view-collaborator',
  templateUrl: './category-packaging-view-collaborator.component.html'
})
export class CategoryPackagingViewCollaboratorComponent implements OnInit {
    ...
    constructor(private service: CategoryPackagingCollaboratorService){
