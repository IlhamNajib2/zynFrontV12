...
@Component({
  selector: 'app-category-packaging-list-collaborator',
  templateUrl: './category-packaging-list-collaborator.component.html'
})
export class CategoryPackagingListCollaboratorComponent implements OnInit {
