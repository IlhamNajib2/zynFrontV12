...
export class PaimentInfluencerStateListAdminComponent implements OnInit {
    ...
    constructor( private service: PaimentInfluencerStateAdminService  , @Inject(PLATFORM_ID) private platformId?) {
