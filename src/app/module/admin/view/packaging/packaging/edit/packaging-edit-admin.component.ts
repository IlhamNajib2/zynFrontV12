...
@Component({
  selector: 'app-packaging-edit-admin',
  templateUrl: './packaging-edit-admin.component.html'
})
export class PackagingEditAdminComponent implements OnInit {
    ...
    constructor(private service: PackagingAdminService , private categoryPackagingService: CategoryPackagingAdminService, @Inject(PLATFORM_ID) private platformId?) {
