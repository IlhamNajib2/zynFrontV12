...
export class CouponViewAdminComponent implements OnInit {
    ...
    constructor(private service: CouponAdminService, private couponDetailService: CouponDetailAdminService, private influencerService: InfluencerAdminService, private packagingService: PackagingAdminService){
