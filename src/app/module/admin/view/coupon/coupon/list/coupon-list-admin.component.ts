...
export class CouponListAdminComponent implements OnInit {
    ...
    constructor( private service: CouponAdminService  , private couponDetailService: CouponDetailAdminService, private influencerService: InfluencerAdminService, private packagingService: PackagingAdminService, @Inject(PLATFORM_ID) private platformId?) {
