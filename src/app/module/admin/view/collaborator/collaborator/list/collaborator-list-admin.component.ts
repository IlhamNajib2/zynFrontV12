...
export class CollaboratorListAdminComponent implements OnInit {
    ...
    constructor( private service: CollaboratorAdminService  , @Inject(PLATFORM_ID) private platformId?) {
