...
export class PaimentInfluencerViewAdminComponent implements OnInit {
    ...
    constructor(private service: PaimentInfluencerAdminService, private couponService: CouponAdminService, private influencerService: InfluencerAdminService, private paimentInfluencerStateService: PaimentInfluencerStateAdminService){
