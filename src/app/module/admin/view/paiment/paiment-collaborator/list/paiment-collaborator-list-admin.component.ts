...
import {PaimentCollaboratorAdminService} from 'src/app/shared/service/admin/paiment/PaimentCollaboratorAdmin.service';
...
import {PaimentCollaboratorStateAdminService} from 'src/app/shared/service/admin/project/PaimentCollaboratorStateAdmin.service';
...
export class PaimentCollaboratorListAdminComponent implements OnInit {
    ...
    constructor( private service: PaimentCollaboratorAdminService  , private couponDetailService: CouponDetailAdminService, private paimentCollaboratorStateService: PaimentCollaboratorStateAdminService, private inscriptionCollaboratorService: InscriptionCollaboratorAdminService, @Inject(PLATFORM_ID) private platformId?) {
