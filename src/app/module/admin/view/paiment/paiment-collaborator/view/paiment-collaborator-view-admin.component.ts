...
export class PaimentCollaboratorViewAdminComponent implements OnInit {
    ...
    constructor(private service: PaimentCollaboratorAdminService, private couponDetailService: CouponDetailAdminService, private paimentCollaboratorStateService: PaimentCollaboratorStateAdminService, private inscriptionCollaboratorService: InscriptionCollaboratorAdminService){
