...
@Component({
  selector: 'app-category-packaging-edit-admin',
  templateUrl: './category-packaging-edit-admin.component.html'
})
export class CategoryPackagingEditAdminComponent implements OnInit {
