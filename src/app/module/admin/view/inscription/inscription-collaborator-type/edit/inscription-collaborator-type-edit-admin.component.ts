...
@Component({
  selector: 'app-inscription-collaborator-type-edit-admin',
  templateUrl: './inscription-collaborator-type-edit-admin.component.html'
})
export class InscriptionCollaboratorTypeEditAdminComponent implements OnInit {
