...
@Component({
  selector: 'app-inscription-collaborator-type-view-admin',
  templateUrl: './inscription-collaborator-type-view-admin.component.html'
})
export class InscriptionCollaboratorTypeViewAdminComponent implements OnInit {
    ...
    constructor(private service: InscriptionCollaboratorTypeAdminService){
