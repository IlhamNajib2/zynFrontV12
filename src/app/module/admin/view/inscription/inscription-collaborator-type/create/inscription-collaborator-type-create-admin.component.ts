...
@Component({
  selector: 'app-inscription-collaborator-type-create-admin',
  templateUrl: './inscription-collaborator-type-create-admin.component.html'
})
export class InscriptionCollaboratorTypeCreateAdminComponent  implements OnInit {
