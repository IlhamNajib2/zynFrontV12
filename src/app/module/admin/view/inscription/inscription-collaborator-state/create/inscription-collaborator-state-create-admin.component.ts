...
@Component({
  selector: 'app-inscription-collaborator-state-create-admin',
  templateUrl: './inscription-collaborator-state-create-admin.component.html'
})
export class InscriptionCollaboratorStateCreateAdminComponent  implements OnInit {
