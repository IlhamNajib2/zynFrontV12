...
@Component({
  selector: 'app-inscription-collaborator-state-edit-admin',
  templateUrl: './inscription-collaborator-state-edit-admin.component.html'
})
export class InscriptionCollaboratorStateEditAdminComponent implements OnInit {
