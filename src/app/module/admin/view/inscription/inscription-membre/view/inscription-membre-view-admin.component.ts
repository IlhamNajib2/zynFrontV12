...
@Component({
  selector: 'app-inscription-membre-view-admin',
  templateUrl: './inscription-membre-view-admin.component.html'
})
export class InscriptionMembreViewAdminComponent implements OnInit {
    ...
    constructor(private service: InscriptionMembreAdminService, private inscriptionMembreStateService: InscriptionMembreStateAdminService, private inscriptionCollaboratorService: InscriptionCollaboratorAdminService, private memberService: MemberAdminService){
