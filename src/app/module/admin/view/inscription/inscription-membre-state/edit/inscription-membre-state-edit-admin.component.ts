...
@Component({
  selector: 'app-inscription-membre-state-edit-admin',
  templateUrl: './inscription-membre-state-edit-admin.component.html'
})
export class InscriptionMembreStateEditAdminComponent implements OnInit {
