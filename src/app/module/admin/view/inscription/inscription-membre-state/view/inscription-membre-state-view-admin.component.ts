...
@Component({
  selector: 'app-inscription-membre-state-view-admin',
  templateUrl: './inscription-membre-state-view-admin.component.html'
})
export class InscriptionMembreStateViewAdminComponent implements OnInit {
    ...
    constructor(private service: InscriptionMembreStateAdminService){
