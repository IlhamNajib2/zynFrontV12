...
@Component({
  selector: 'app-type-template-create-admin',
  templateUrl: './type-template-create-admin.component.html'
})
export class TypeTemplateCreateAdminComponent  implements OnInit {
