...
@Component({
  selector: 'app-type-template-view-admin',
  templateUrl: './type-template-view-admin.component.html'
})
export class TypeTemplateViewAdminComponent implements OnInit {
    ...
    constructor(private service: TypeTemplateAdminService){
