...
@Component({
  selector: 'app-template-edit-admin',
  templateUrl: './template-edit-admin.component.html'
})
export class TemplateEditAdminComponent implements OnInit {
