...
@Component({
  selector: 'app-level-template-view-admin',
  templateUrl: './level-template-view-admin.component.html'
})
export class LevelTemplateViewAdminComponent implements OnInit {
    ...
    constructor(private service: LevelTemplateAdminService){
