...
@Component({
  selector: 'app-level-template-edit-admin',
  templateUrl: './level-template-edit-admin.component.html'
})
export class LevelTemplateEditAdminComponent implements OnInit {
