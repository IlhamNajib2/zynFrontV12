...
export class DomainTemplateListAdminComponent implements OnInit {
    ...
    constructor( private service: DomainTemplateAdminService  , @Inject(PLATFORM_ID) private platformId?) {
