...
@Component({
  selector: 'app-domain-template-edit-admin',
  templateUrl: './domain-template-edit-admin.component.html'
})
export class DomainTemplateEditAdminComponent implements OnInit {
