...
@Component({
  selector: 'app-category-template-view-admin',
  templateUrl: './category-template-view-admin.component.html'
})
export class CategoryTemplateViewAdminComponent implements OnInit {
    ...
    constructor(private service: CategoryTemplateAdminService){
