...
@Component({
  selector: 'app-category-template-edit-admin',
  templateUrl: './category-template-edit-admin.component.html'
})
export class CategoryTemplateEditAdminComponent implements OnInit {
