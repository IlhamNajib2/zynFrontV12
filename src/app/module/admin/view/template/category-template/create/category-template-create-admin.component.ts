...
@Component({
  selector: 'app-category-template-create-admin',
  templateUrl: './category-template-create-admin.component.html'
})
export class CategoryTemplateCreateAdminComponent  implements OnInit {
