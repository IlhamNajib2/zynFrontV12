...
@Component({
  selector: 'app-technology-list-admin',
  templateUrl: './technology-list-admin.component.html'
})
export class TechnologyListAdminComponent implements OnInit {
    ...
    constructor( private service: TechnologyAdminService  , private typeTemplateService: TypeTemplateAdminService, @Inject(PLATFORM_ID) private platformId?) {
