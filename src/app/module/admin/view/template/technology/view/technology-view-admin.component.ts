...
@Component({
  selector: 'app-technology-view-admin',
  templateUrl: './technology-view-admin.component.html'
})
export class TechnologyViewAdminComponent implements OnInit {
    ...
    constructor(private service: TechnologyAdminService, private typeTemplateService: TypeTemplateAdminService){
