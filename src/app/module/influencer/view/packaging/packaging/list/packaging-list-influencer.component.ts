...
@Component({
  selector: 'app-packaging-list-influencer',
  templateUrl: './packaging-list-influencer.component.html'
})
export class PackagingListInfluencerComponent implements OnInit {
