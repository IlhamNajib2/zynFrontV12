...
@Component({
  selector: 'app-packaging-create-influencer',
  templateUrl: './packaging-create-influencer.component.html'
})
export class PackagingCreateInfluencerComponent  implements OnInit {
   ...
   private _validPackagingCode = true;
	...
	constructor(private service: PackagingInfluencerService , private categoryPackagingService: CategoryPackagingInfluencerService, @Inject(PLATFORM_ID) private platformId? ) {
