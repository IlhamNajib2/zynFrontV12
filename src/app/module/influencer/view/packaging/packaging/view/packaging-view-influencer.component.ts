...
@Component({
  selector: 'app-packaging-view-influencer',
  templateUrl: './packaging-view-influencer.component.html'
})
export class PackagingViewInfluencerComponent implements OnInit {
    ...
    constructor(private service: PackagingInfluencerService, private categoryPackagingService: CategoryPackagingInfluencerService){
