...
@Component({
  selector: 'app-paiment-collaborator-edit-influencer',
  templateUrl: './paiment-collaborator-edit-influencer.component.html'
})
export class PaimentCollaboratorEditInfluencerComponent implements OnInit {
