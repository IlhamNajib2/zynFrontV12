...
@Component({
  selector: 'app-paiment-collaborator-list-influencer',
  templateUrl: './paiment-collaborator-list-influencer.component.html'
})
export class PaimentCollaboratorListInfluencerComponent implements OnInit {
