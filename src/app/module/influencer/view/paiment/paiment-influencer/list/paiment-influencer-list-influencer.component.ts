...
@Component({
  selector: 'app-paiment-influencer-list-influencer',
  templateUrl: './paiment-influencer-list-influencer.component.html'
})
export class PaimentInfluencerListInfluencerComponent implements OnInit {
