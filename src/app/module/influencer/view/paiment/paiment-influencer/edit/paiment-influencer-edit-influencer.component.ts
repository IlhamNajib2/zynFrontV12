...
@Component({
  selector: 'app-paiment-influencer-edit-influencer',
  templateUrl: './paiment-influencer-edit-influencer.component.html'
})
export class PaimentInfluencerEditInfluencerComponent implements OnInit {
