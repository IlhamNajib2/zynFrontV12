...
@Component({
  selector: 'app-collaborator-view-influencer',
  templateUrl: './collaborator-view-influencer.component.html'
})
export class CollaboratorViewInfluencerComponent implements OnInit {
    ...
    constructor(private service: CollaboratorInfluencerService){
