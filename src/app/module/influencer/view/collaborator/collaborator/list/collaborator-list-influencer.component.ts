...
@Component({
  selector: 'app-collaborator-list-influencer',
  templateUrl: './collaborator-list-influencer.component.html'
})
export class CollaboratorListInfluencerComponent implements OnInit {
    ...
    constructor( private service: CollaboratorInfluencerService  , @Inject(PLATFORM_ID) private platformId?) {
