...
@Component({
  selector: 'app-member-view-influencer',
  templateUrl: './member-view-influencer.component.html'
})
export class MemberViewInfluencerComponent implements OnInit {
    ...
    constructor(private service: MemberInfluencerService, private collaboratorService: CollaboratorInfluencerService){
