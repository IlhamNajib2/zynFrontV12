...
@Component({
  selector: 'app-member-list-influencer',
  templateUrl: './member-list-influencer.component.html'
})
export class MemberListInfluencerComponent implements OnInit {
    ...
    constructor( private service: MemberInfluencerService  , private collaboratorService: CollaboratorInfluencerService, @Inject(PLATFORM_ID) private platformId?) {
