...
@Component({
  selector: 'app-category-template-view-influencer',
  templateUrl: './category-template-view-influencer.component.html'
})
export class CategoryTemplateViewInfluencerComponent implements OnInit {
    ...
    constructor(private service: CategoryTemplateInfluencerService){
