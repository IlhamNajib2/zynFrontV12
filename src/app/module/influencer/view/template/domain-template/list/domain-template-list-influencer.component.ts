...
@Component({
  selector: 'app-domain-template-list-influencer',
  templateUrl: './domain-template-list-influencer.component.html'
})
export class DomainTemplateListInfluencerComponent implements OnInit {
