...
@Component({
  selector: 'app-domain-template-view-influencer',
  templateUrl: './domain-template-view-influencer.component.html'
})
export class DomainTemplateViewInfluencerComponent implements OnInit {
    ...
    constructor(private service: DomainTemplateInfluencerService){
