...
@Component({
  selector: 'app-type-template-view-influencer',
  templateUrl: './type-template-view-influencer.component.html'
})
export class TypeTemplateViewInfluencerComponent implements OnInit {
    ...
    constructor(private service: TypeTemplateInfluencerService){
