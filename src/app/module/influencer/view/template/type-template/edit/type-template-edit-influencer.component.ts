...
@Component({
  selector: 'app-type-template-edit-influencer',
  templateUrl: './type-template-edit-influencer.component.html'
})
export class TypeTemplateEditInfluencerComponent implements OnInit {
