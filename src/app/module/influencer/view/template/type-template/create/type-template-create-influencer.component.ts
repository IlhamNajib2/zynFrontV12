...
@Component({
  selector: 'app-type-template-create-influencer',
  templateUrl: './type-template-create-influencer.component.html'
})
export class TypeTemplateCreateInfluencerComponent  implements OnInit {
