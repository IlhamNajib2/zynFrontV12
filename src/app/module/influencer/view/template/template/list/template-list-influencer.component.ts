...
@Component({
  selector: 'app-template-list-influencer',
  templateUrl: './template-list-influencer.component.html'
})
export class TemplateListInfluencerComponent implements OnInit {
