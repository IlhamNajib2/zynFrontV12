...
@Component({
  selector: 'app-technology-edit-influencer',
  templateUrl: './technology-edit-influencer.component.html'
})
export class TechnologyEditInfluencerComponent implements OnInit {
