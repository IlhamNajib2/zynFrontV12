...
@Component({
  selector: 'app-technology-list-influencer',
  templateUrl: './technology-list-influencer.component.html'
})
export class TechnologyListInfluencerComponent implements OnInit {

    protected fileName = 'Technology';
    ...
    constructor( private service: TechnologyInfluencerService  , private typeTemplateService: TypeTemplateInfluencerService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<TechnologyDto>();
    ...
    public async edit(dto: TechnologyDto) {
    ...
    public async view(dto: TechnologyDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: TechnologyDto) {
    ...
    public async duplicate(dto: TechnologyDto) {
    ...
    public exportPdf(dto: TechnologyDto): void {
...
// add
	...
	public initDuplicate(res: TechnologyDto) {
	}
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<TechnologyDto> {
        return this.service.selections;
    }

    set selections(value: Array<TechnologyDto>) {
