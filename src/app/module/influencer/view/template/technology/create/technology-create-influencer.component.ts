...
@Component({
  selector: 'app-technology-create-influencer',
  templateUrl: './technology-create-influencer.component.html'
})
export class TechnologyCreateInfluencerComponent  implements OnInit {
