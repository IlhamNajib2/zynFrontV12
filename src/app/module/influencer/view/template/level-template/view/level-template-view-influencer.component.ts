...
@Component({
  selector: 'app-level-template-view-influencer',
  templateUrl: './level-template-view-influencer.component.html'
})
export class LevelTemplateViewInfluencerComponent implements OnInit {
    ...
    constructor(private service: LevelTemplateInfluencerService){
