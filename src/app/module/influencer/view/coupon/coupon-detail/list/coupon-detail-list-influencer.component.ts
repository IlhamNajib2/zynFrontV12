...
@Component({
  selector: 'app-coupon-detail-list-influencer',
  templateUrl: './coupon-detail-list-influencer.component.html'
})
export class CouponDetailListInfluencerComponent implements OnInit {
