...
@Component({
  selector: 'app-coupon-detail-view-influencer',
  templateUrl: './coupon-detail-view-influencer.component.html'
})
export class CouponDetailViewInfluencerComponent implements OnInit {
    ...
    constructor(private service: CouponDetailInfluencerService, private couponService: CouponInfluencerService, private packagingService: PackagingInfluencerService){
