...
@Component({
  selector: 'app-coupon-detail-edit-influencer',
  templateUrl: './coupon-detail-edit-influencer.component.html'
})
export class CouponDetailEditInfluencerComponent implements OnInit {
