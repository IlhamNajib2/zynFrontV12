...
@Component({
  selector: 'app-influencer-list-influencer',
  templateUrl: './influencer-list-influencer.component.html'
})
export class InfluencerListInfluencerComponent implements OnInit {
    ...
    constructor( private service: InfluencerInfluencerService  , @Inject(PLATFORM_ID) private platformId?) {
