...
@Component({
  selector: 'app-coupon-view-influencer',
  templateUrl: './coupon-view-influencer.component.html'
})
export class CouponViewInfluencerComponent implements OnInit {
    ...
    constructor(private service: CouponInfluencerService, private couponDetailService: CouponDetailInfluencerService, private influencerService: InfluencerInfluencerService, private packagingService: PackagingInfluencerService){
