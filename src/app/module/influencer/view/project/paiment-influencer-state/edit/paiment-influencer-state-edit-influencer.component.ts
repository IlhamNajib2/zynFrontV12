...
@Component({
  selector: 'app-paiment-influencer-state-edit-influencer',
  templateUrl: './paiment-influencer-state-edit-influencer.component.html'
})
export class PaimentInfluencerStateEditInfluencerComponent implements OnInit {
