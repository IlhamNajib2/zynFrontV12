...
@Component({
  selector: 'app-paiment-influencer-state-create-influencer',
  templateUrl: './paiment-influencer-state-create-influencer.component.html'
})
export class PaimentInfluencerStateCreateInfluencerComponent  implements OnInit {
