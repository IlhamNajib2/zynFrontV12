...
@Component({
  selector: 'app-paiment-collaborator-state-edit-influencer',
  templateUrl: './paiment-collaborator-state-edit-influencer.component.html'
})
export class PaimentCollaboratorStateEditInfluencerComponent implements OnInit {
