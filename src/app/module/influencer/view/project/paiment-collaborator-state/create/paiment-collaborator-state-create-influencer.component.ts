...
@Component({
  selector: 'app-paiment-collaborator-state-create-influencer',
  templateUrl: './paiment-collaborator-state-create-influencer.component.html'
})
export class PaimentCollaboratorStateCreateInfluencerComponent  implements OnInit {
   ...
   private _validPaimentCollaboratorStateCode = true;
	...
	constructor(private service: PaimentCollaboratorStateInfluencerService , @Inject(PLATFORM_ID) private platformId? ) {
