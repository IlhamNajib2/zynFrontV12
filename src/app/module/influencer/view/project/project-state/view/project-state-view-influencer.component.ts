...
@Component({
  selector: 'app-project-state-view-influencer',
  templateUrl: './project-state-view-influencer.component.html'
})
export class ProjectStateViewInfluencerComponent implements OnInit {
    ...
    constructor(private service: ProjectStateInfluencerService){
