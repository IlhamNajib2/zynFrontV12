...
@Component({
  selector: 'app-category-packaging-view-influencer',
  templateUrl: './category-packaging-view-influencer.component.html'
})
export class CategoryPackagingViewInfluencerComponent implements OnInit {
    ...
    constructor(private service: CategoryPackagingInfluencerService){
