...
@Component({
  selector: 'app-inscription-collaborator-type-view-influencer',
  templateUrl: './inscription-collaborator-type-view-influencer.component.html'
})
export class InscriptionCollaboratorTypeViewInfluencerComponent implements OnInit {
    ...
    constructor(private service: InscriptionCollaboratorTypeInfluencerService){
