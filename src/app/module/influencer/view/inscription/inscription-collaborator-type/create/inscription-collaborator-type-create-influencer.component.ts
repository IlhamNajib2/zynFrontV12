...
@Component({
  selector: 'app-inscription-collaborator-type-create-influencer',
  templateUrl: './inscription-collaborator-type-create-influencer.component.html'
})
export class InscriptionCollaboratorTypeCreateInfluencerComponent  implements OnInit {
