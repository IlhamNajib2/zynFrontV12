...
@Component({
  selector: 'app-inscription-collaborator-type-edit-influencer',
  templateUrl: './inscription-collaborator-type-edit-influencer.component.html'
})
export class InscriptionCollaboratorTypeEditInfluencerComponent implements OnInit {
