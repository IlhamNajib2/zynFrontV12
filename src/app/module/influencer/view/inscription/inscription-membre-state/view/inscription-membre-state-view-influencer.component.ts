...
@Component({
  selector: 'app-inscription-membre-state-view-influencer',
  templateUrl: './inscription-membre-state-view-influencer.component.html'
})
export class InscriptionMembreStateViewInfluencerComponent implements OnInit {
    ...
    constructor(private service: InscriptionMembreStateInfluencerService){
