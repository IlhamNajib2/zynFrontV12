...
@Component({
  selector: 'app-inscription-membre-state-edit-influencer',
  templateUrl: './inscription-membre-state-edit-influencer.component.html'
})
export class InscriptionMembreStateEditInfluencerComponent implements OnInit {
