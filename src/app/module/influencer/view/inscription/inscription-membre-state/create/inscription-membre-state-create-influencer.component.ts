...
@Component({
  selector: 'app-inscription-membre-state-create-influencer',
  templateUrl: './inscription-membre-state-create-influencer.component.html'
})
export class InscriptionMembreStateCreateInfluencerComponent  implements OnInit {
