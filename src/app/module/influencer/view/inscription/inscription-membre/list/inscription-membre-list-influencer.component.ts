...
@Component({
  selector: 'app-inscription-membre-list-influencer',
  templateUrl: './inscription-membre-list-influencer.component.html'
})
export class InscriptionMembreListInfluencerComponent implements OnInit {
