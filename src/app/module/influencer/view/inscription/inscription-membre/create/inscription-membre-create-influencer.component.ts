...
@Component({
  selector: 'app-inscription-membre-create-influencer',
  templateUrl: './inscription-membre-create-influencer.component.html'
})
export class InscriptionMembreCreateInfluencerComponent  implements OnInit {
	...
	constructor(private service: InscriptionMembreInfluencerService , private inscriptionMembreStateService: InscriptionMembreStateInfluencerService, private inscriptionCollaboratorService: InscriptionCollaboratorInfluencerService, private memberService: MemberInfluencerService, @Inject(PLATFORM_ID) private platformId? ) {
