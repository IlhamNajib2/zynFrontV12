...
@Component({
  selector: 'app-inscription-membre-edit-influencer',
  templateUrl: './inscription-membre-edit-influencer.component.html'
})
export class InscriptionMembreEditInfluencerComponent implements OnInit {
