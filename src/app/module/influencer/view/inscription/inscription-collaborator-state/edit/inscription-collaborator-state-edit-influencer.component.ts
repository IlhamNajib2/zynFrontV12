...
@Component({
  selector: 'app-inscription-collaborator-state-edit-influencer',
  templateUrl: './inscription-collaborator-state-edit-influencer.component.html'
})
export class InscriptionCollaboratorStateEditInfluencerComponent implements OnInit {
