...
@Component({
  selector: 'app-inscription-collaborator-state-view-influencer',
  templateUrl: './inscription-collaborator-state-view-influencer.component.html'
})
export class InscriptionCollaboratorStateViewInfluencerComponent implements OnInit {
    ...
    constructor(private service: InscriptionCollaboratorStateInfluencerService){
