...
@Component({
  selector: 'app-inscription-collaborator-state-create-influencer',
  templateUrl: './inscription-collaborator-state-create-influencer.component.html'
})
export class InscriptionCollaboratorStateCreateInfluencerComponent  implements OnInit {
