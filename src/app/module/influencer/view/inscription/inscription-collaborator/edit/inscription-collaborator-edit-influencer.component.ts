...
@Component({
  selector: 'app-inscription-collaborator-edit-influencer',
  templateUrl: './inscription-collaborator-edit-influencer.component.html'
})
export class InscriptionCollaboratorEditInfluencerComponent implements OnInit {
