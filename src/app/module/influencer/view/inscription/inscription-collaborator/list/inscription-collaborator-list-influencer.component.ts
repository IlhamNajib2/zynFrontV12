...
@Component({
  selector: 'app-inscription-collaborator-list-influencer',
  templateUrl: './inscription-collaborator-list-influencer.component.html'
})
export class InscriptionCollaboratorListInfluencerComponent implements OnInit {
