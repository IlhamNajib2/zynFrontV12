...
@Component({
  selector: 'app-coupon-detail-create-member',
  templateUrl: './coupon-detail-create-member.component.html'
})
export class CouponDetailCreateMemberComponent  implements OnInit {
	...
	constructor(private service: CouponDetailMemberService , private couponService: CouponMemberService, private packagingService: PackagingMemberService, @Inject(PLATFORM_ID) private platformId? ) {
