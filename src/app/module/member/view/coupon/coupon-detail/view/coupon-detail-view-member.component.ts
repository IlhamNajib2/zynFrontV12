...
@Component({
  selector: 'app-coupon-detail-view-member',
  templateUrl: './coupon-detail-view-member.component.html'
})
export class CouponDetailViewMemberComponent implements OnInit {
    ...
    constructor(private service: CouponDetailMemberService, private couponService: CouponMemberService, private packagingService: PackagingMemberService){
