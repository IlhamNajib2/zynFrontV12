...
@Component({
  selector: 'app-coupon-detail-list-member',
  templateUrl: './coupon-detail-list-member.component.html'
})
export class CouponDetailListMemberComponent implements OnInit {
