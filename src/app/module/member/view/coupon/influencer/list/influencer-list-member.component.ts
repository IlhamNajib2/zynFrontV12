...
@Component({
  selector: 'app-influencer-list-member',
  templateUrl: './influencer-list-member.component.html'
})
export class InfluencerListMemberComponent implements OnInit {
    ...
    constructor( private service: InfluencerMemberService  , @Inject(PLATFORM_ID) private platformId?) {
