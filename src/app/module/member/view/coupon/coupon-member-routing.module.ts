                    ...
                    children: [
...

                        {
                            ...
                            children: [
                                {
                                    path: 'list',
                                    component: InfluencerListMemberComponent ,
                                    canActivate: [AuthGuard]
                                }
                            ]
                        },

                        {
                            ...
                            children: [
                                {
                                    path: 'list',
                                    component: CouponListMemberComponent ,
                                    canActivate: [AuthGuard]
                                }
                            ]
                        },

                        {
                            ...
                            children: [
                                {
                                    path: 'list',
                                    component: CouponDetailListMemberComponent ,
                                    canActivate: [AuthGuard]
                                }
                            ]
                        },
...
export class CouponMemberRoutingModule { }
