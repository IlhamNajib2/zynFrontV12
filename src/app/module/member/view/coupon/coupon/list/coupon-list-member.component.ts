...
@Component({
  selector: 'app-coupon-list-member',
  templateUrl: './coupon-list-member.component.html'
})
export class CouponListMemberComponent implements OnInit {

    protected fileName = 'Coupon';
    ...
    constructor( private service: CouponMemberService  , private couponDetailService: CouponDetailMemberService, private influencerService: InfluencerMemberService, private packagingService: PackagingMemberService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<CouponDto>();
    ...
    public async edit(dto: CouponDto) {
    ...
    public async view(dto: CouponDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: CouponDto) {
    ...
    public async duplicate(dto: CouponDto) {
    ...
    public exportPdf(dto: CouponDto): void {
...
// add
	...
	public initDuplicate(res: CouponDto) {
        if (res.couponDetails != null) {
             res.couponDetails.forEach(d => { d.coupon = null; d.id = null; });
        }
	}
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<CouponDto> {
        return this.service.selections;
    }

    set selections(value: Array<CouponDto>) {
