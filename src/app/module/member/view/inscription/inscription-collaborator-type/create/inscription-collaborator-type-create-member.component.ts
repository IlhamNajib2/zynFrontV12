...
@Component({
  selector: 'app-inscription-collaborator-type-create-member',
  templateUrl: './inscription-collaborator-type-create-member.component.html'
})
export class InscriptionCollaboratorTypeCreateMemberComponent  implements OnInit {
