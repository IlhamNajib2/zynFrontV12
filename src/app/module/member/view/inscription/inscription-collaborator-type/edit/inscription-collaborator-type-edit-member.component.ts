...
@Component({
  selector: 'app-inscription-collaborator-type-edit-member',
  templateUrl: './inscription-collaborator-type-edit-member.component.html'
})
export class InscriptionCollaboratorTypeEditMemberComponent implements OnInit {
