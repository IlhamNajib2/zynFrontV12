...
@Component({
  selector: 'app-inscription-collaborator-list-member',
  templateUrl: './inscription-collaborator-list-member.component.html'
})
export class InscriptionCollaboratorListMemberComponent implements OnInit {
