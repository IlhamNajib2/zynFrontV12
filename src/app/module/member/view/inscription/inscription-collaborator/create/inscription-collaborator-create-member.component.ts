...
@Component({
  selector: 'app-inscription-collaborator-create-member',
  templateUrl: './inscription-collaborator-create-member.component.html'
})
export class InscriptionCollaboratorCreateMemberComponent  implements OnInit {
