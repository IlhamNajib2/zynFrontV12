...
@Component({
  selector: 'app-inscription-membre-view-member',
  templateUrl: './inscription-membre-view-member.component.html'
})
export class InscriptionMembreViewMemberComponent implements OnInit {
    ...
    constructor(private service: InscriptionMembreMemberService, private inscriptionMembreStateService: InscriptionMembreStateMemberService, private inscriptionCollaboratorService: InscriptionCollaboratorMemberService, private memberService: MemberMemberService){
