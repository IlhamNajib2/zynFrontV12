...
@Component({
  selector: 'app-inscription-membre-edit-member',
  templateUrl: './inscription-membre-edit-member.component.html'
})
export class InscriptionMembreEditMemberComponent implements OnInit {
