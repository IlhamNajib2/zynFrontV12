...
@Component({
  selector: 'app-inscription-membre-list-member',
  templateUrl: './inscription-membre-list-member.component.html'
})
export class InscriptionMembreListMemberComponent implements OnInit {
