...
@Component({
  selector: 'app-inscription-membre-create-member',
  templateUrl: './inscription-membre-create-member.component.html'
})
export class InscriptionMembreCreateMemberComponent  implements OnInit {
	...
	constructor(private service: InscriptionMembreMemberService , private inscriptionMembreStateService: InscriptionMembreStateMemberService, private inscriptionCollaboratorService: InscriptionCollaboratorMemberService, private memberService: MemberMemberService, @Inject(PLATFORM_ID) private platformId? ) {
