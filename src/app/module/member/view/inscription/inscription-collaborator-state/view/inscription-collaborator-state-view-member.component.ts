...
@Component({
  selector: 'app-inscription-collaborator-state-view-member',
  templateUrl: './inscription-collaborator-state-view-member.component.html'
})
export class InscriptionCollaboratorStateViewMemberComponent implements OnInit {
    ...
    constructor(private service: InscriptionCollaboratorStateMemberService){
