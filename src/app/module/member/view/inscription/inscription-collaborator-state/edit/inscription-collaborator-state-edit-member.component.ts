...
@Component({
  selector: 'app-inscription-collaborator-state-edit-member',
  templateUrl: './inscription-collaborator-state-edit-member.component.html'
})
export class InscriptionCollaboratorStateEditMemberComponent implements OnInit {
