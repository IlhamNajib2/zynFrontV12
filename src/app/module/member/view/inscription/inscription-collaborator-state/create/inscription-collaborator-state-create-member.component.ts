...
@Component({
  selector: 'app-inscription-collaborator-state-create-member',
  templateUrl: './inscription-collaborator-state-create-member.component.html'
})
export class InscriptionCollaboratorStateCreateMemberComponent  implements OnInit {
