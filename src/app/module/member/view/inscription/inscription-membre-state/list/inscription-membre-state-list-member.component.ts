...
@Component({
  selector: 'app-inscription-membre-state-list-member',
  templateUrl: './inscription-membre-state-list-member.component.html'
})
export class InscriptionMembreStateListMemberComponent implements OnInit {
