...
@Component({
  selector: 'app-inscription-membre-state-edit-member',
  templateUrl: './inscription-membre-state-edit-member.component.html'
})
export class InscriptionMembreStateEditMemberComponent implements OnInit {
