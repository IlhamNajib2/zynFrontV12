...
@Component({
  selector: 'app-member-list-member',
  templateUrl: './member-list-member.component.html'
})
export class MemberListMemberComponent implements OnInit {
    ...
    constructor( private service: MemberMemberService  , private collaboratorService: CollaboratorMemberService, @Inject(PLATFORM_ID) private platformId?) {
