...
@Component({
  selector: 'app-collaborator-list-member',
  templateUrl: './collaborator-list-member.component.html'
})
export class CollaboratorListMemberComponent implements OnInit {
    ...
    constructor( private service: CollaboratorMemberService  , @Inject(PLATFORM_ID) private platformId?) {
