...
@Component({
  selector: 'app-collaborator-edit-member',
  templateUrl: './collaborator-edit-member.component.html'
})
export class CollaboratorEditMemberComponent implements OnInit {
