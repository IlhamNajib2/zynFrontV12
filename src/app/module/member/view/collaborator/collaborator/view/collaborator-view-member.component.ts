...
@Component({
  selector: 'app-collaborator-view-member',
  templateUrl: './collaborator-view-member.component.html'
})
export class CollaboratorViewMemberComponent implements OnInit {
    ...
    constructor(private service: CollaboratorMemberService){
