...
@Component({
  selector: 'app-paiment-collaborator-list-member',
  templateUrl: './paiment-collaborator-list-member.component.html'
})
export class PaimentCollaboratorListMemberComponent implements OnInit {
