...
import {PaimentCollaboratorMemberService} from 'src/app/shared/service/member/paiment/PaimentCollaboratorMember.service';
...
import {PaimentCollaboratorStateMemberService} from 'src/app/shared/service/member/project/PaimentCollaboratorStateMember.service';
...
@Component({
  selector: 'app-paiment-collaborator-create-member',
  templateUrl: './paiment-collaborator-create-member.component.html'
})
export class PaimentCollaboratorCreateMemberComponent  implements OnInit {
   ...
   private _validPaimentCollaboratorCode = true;
	...
	constructor(private service: PaimentCollaboratorMemberService , private couponDetailService: CouponDetailMemberService, private paimentCollaboratorStateService: PaimentCollaboratorStateMemberService, private inscriptionCollaboratorService: InscriptionCollaboratorMemberService, @Inject(PLATFORM_ID) private platformId? ) {
