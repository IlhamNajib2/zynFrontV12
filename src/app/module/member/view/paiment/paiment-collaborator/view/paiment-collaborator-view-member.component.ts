...
@Component({
  selector: 'app-paiment-collaborator-view-member',
  templateUrl: './paiment-collaborator-view-member.component.html'
})
export class PaimentCollaboratorViewMemberComponent implements OnInit {
