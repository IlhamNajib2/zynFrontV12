...
@Component({
  selector: 'app-paiment-collaborator-edit-member',
  templateUrl: './paiment-collaborator-edit-member.component.html'
})
export class PaimentCollaboratorEditMemberComponent implements OnInit {
