...
@Component({
  selector: 'app-paiment-influencer-list-member',
  templateUrl: './paiment-influencer-list-member.component.html'
})
export class PaimentInfluencerListMemberComponent implements OnInit {
