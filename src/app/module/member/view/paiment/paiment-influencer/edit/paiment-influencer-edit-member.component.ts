...
@Component({
  selector: 'app-paiment-influencer-edit-member',
  templateUrl: './paiment-influencer-edit-member.component.html'
})
export class PaimentInfluencerEditMemberComponent implements OnInit {
