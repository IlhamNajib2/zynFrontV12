...
@Component({
  selector: 'app-paiment-influencer-view-member',
  templateUrl: './paiment-influencer-view-member.component.html'
})
export class PaimentInfluencerViewMemberComponent implements OnInit {
    ...
    constructor(private service: PaimentInfluencerMemberService, private couponService: CouponMemberService, private influencerService: InfluencerMemberService, private paimentInfluencerStateService: PaimentInfluencerStateMemberService){
