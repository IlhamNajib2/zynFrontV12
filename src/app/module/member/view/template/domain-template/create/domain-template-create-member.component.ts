...
@Component({
  selector: 'app-domain-template-create-member',
  templateUrl: './domain-template-create-member.component.html'
})
export class DomainTemplateCreateMemberComponent  implements OnInit {
