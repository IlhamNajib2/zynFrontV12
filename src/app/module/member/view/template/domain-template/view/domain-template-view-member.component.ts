...
@Component({
  selector: 'app-domain-template-view-member',
  templateUrl: './domain-template-view-member.component.html'
})
export class DomainTemplateViewMemberComponent implements OnInit {
    ...
    constructor(private service: DomainTemplateMemberService){
