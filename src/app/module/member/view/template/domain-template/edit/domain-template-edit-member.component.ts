...
@Component({
  selector: 'app-domain-template-edit-member',
  templateUrl: './domain-template-edit-member.component.html'
})
export class DomainTemplateEditMemberComponent implements OnInit {
