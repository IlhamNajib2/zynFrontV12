...
@Component({
  selector: 'app-category-template-view-member',
  templateUrl: './category-template-view-member.component.html'
})
export class CategoryTemplateViewMemberComponent implements OnInit {
    ...
    constructor(private service: CategoryTemplateMemberService){
