...
@Component({
  selector: 'app-category-template-list-member',
  templateUrl: './category-template-list-member.component.html'
})
export class CategoryTemplateListMemberComponent implements OnInit {
