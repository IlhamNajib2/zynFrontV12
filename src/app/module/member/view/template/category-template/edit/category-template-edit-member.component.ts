...
@Component({
  selector: 'app-category-template-edit-member',
  templateUrl: './category-template-edit-member.component.html'
})
export class CategoryTemplateEditMemberComponent implements OnInit {
