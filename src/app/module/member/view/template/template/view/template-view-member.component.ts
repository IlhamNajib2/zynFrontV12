...
@Component({
  selector: 'app-template-view-member',
  templateUrl: './template-view-member.component.html'
})
export class TemplateViewMemberComponent implements OnInit {
    ...
    constructor(private service: TemplateMemberService, private categoryTemplateService: CategoryTemplateMemberService, private technologyService: TechnologyMemberService, private levelTemplateService: LevelTemplateMemberService, private typeTemplateService: TypeTemplateMemberService, private domainTemplateService: DomainTemplateMemberService, private memberService: MemberMemberService){
