...
@Component({
  selector: 'app-level-template-view-member',
  templateUrl: './level-template-view-member.component.html'
})
export class LevelTemplateViewMemberComponent implements OnInit {
    ...
    constructor(private service: LevelTemplateMemberService){
