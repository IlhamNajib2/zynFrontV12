...
@Component({
  selector: 'app-technology-view-member',
  templateUrl: './technology-view-member.component.html'
})
export class TechnologyViewMemberComponent implements OnInit {
    ...
    constructor(private service: TechnologyMemberService, private typeTemplateService: TypeTemplateMemberService){
