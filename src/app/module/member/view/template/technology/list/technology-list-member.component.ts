...
@Component({
  selector: 'app-technology-list-member',
  templateUrl: './technology-list-member.component.html'
})
export class TechnologyListMemberComponent implements OnInit {
    ...
    constructor( private service: TechnologyMemberService  , private typeTemplateService: TypeTemplateMemberService, @Inject(PLATFORM_ID) private platformId?) {
