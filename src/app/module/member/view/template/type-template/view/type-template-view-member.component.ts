...
@Component({
  selector: 'app-type-template-view-member',
  templateUrl: './type-template-view-member.component.html'
})
export class TypeTemplateViewMemberComponent implements OnInit {
    ...
    constructor(private service: TypeTemplateMemberService){
