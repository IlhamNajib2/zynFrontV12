...
@Component({
  selector: 'app-type-template-edit-member',
  templateUrl: './type-template-edit-member.component.html'
})
export class TypeTemplateEditMemberComponent implements OnInit {
