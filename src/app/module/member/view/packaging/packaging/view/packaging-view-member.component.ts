...
@Component({
  selector: 'app-packaging-view-member',
  templateUrl: './packaging-view-member.component.html'
})
export class PackagingViewMemberComponent implements OnInit {
    ...
    constructor(private service: PackagingMemberService, private categoryPackagingService: CategoryPackagingMemberService){
