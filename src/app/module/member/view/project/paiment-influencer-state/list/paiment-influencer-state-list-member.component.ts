...
@Component({
  selector: 'app-paiment-influencer-state-list-member',
  templateUrl: './paiment-influencer-state-list-member.component.html'
})
export class PaimentInfluencerStateListMemberComponent implements OnInit {
