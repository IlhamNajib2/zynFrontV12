...
@Component({
  selector: 'app-paiment-influencer-state-edit-member',
  templateUrl: './paiment-influencer-state-edit-member.component.html'
})
export class PaimentInfluencerStateEditMemberComponent implements OnInit {
