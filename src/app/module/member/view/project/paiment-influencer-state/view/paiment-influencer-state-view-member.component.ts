...
@Component({
  selector: 'app-paiment-influencer-state-view-member',
  templateUrl: './paiment-influencer-state-view-member.component.html'
})
export class PaimentInfluencerStateViewMemberComponent implements OnInit {
    ...
    constructor(private service: PaimentInfluencerStateMemberService){
