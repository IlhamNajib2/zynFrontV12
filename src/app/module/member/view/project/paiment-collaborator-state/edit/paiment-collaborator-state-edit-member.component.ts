...
@Component({
  selector: 'app-paiment-collaborator-state-edit-member',
  templateUrl: './paiment-collaborator-state-edit-member.component.html'
})
export class PaimentCollaboratorStateEditMemberComponent implements OnInit {
