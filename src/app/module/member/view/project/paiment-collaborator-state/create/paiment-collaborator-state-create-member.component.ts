...
@Component({
  selector: 'app-paiment-collaborator-state-create-member',
  templateUrl: './paiment-collaborator-state-create-member.component.html'
})
export class PaimentCollaboratorStateCreateMemberComponent  implements OnInit {
   ...
   private _validPaimentCollaboratorStateCode = true;
	...
	constructor(private service: PaimentCollaboratorStateMemberService , @Inject(PLATFORM_ID) private platformId? ) {
