...
@Component({
  selector: 'app-paiment-collaborator-state-view-member',
  templateUrl: './paiment-collaborator-state-view-member.component.html'
})
export class PaimentCollaboratorStateViewMemberComponent implements OnInit {
    ...
    constructor(private service: PaimentCollaboratorStateMemberService){
