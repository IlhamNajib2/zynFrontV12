...
@Component({
  selector: 'app-project-state-view-member',
  templateUrl: './project-state-view-member.component.html'
})
export class ProjectStateViewMemberComponent implements OnInit {
    ...
    constructor(private service: ProjectStateMemberService){
