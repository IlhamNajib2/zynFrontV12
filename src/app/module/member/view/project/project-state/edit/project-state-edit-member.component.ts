...
@Component({
  selector: 'app-project-state-edit-member',
  templateUrl: './project-state-edit-member.component.html'
})
export class ProjectStateEditMemberComponent implements OnInit {
