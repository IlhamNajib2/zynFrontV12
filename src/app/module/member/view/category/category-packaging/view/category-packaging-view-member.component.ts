...
@Component({
  selector: 'app-category-packaging-view-member',
  templateUrl: './category-packaging-view-member.component.html'
})
export class CategoryPackagingViewMemberComponent implements OnInit {
    ...
    constructor(private service: CategoryPackagingMemberService){
