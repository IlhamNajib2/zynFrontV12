...
export class ProjectAdminService {
    ...
    private countsUpdated = new Subject<void>();
    constructor(private http: HttpClient) {
        this.API_PERMISSION = environment.apiUrl + 'modelPermissionUser/';
    }


    triggerCountsUpdate(): void {
    ...
    countProjectsByDay(date: string): Observable<number> {
        const params = new HttpParams().set('date', date);
        return this.http.get<number>(this.API + 'countProjectsByDay', { params });
    }

    countProjectsByWeek(date: string): Observable<number> {
        const params = new HttpParams().set('date', date);
        return this.http.get<number>(this.API + 'countProjectsByWeek', { params });
    }

    countProjectsByMonth(date: string): Observable<number> {
        const params = new HttpParams().set('date', date);
        return this.http.get<number>(this.API + 'countProjectsByMonth', { params });
    }

    countProjectsByYear(date: string): Observable<number> {
        const params = new HttpParams().set('date', date);
        return this.http.get<number>(this.API + 'countProjectsByYear', { params });
    }
    ...
    get API() {
        return environment.apiUrlZynservice + 'admin/project/';
    }
